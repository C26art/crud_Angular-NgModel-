...
const EXAMPLE_DATA: Product[] = [
  {id: '1', nome: 'Hydrogen', quantidade: '20', fornecedor: 'hortfruit', validade: '23/04/2023', categoria: 'frutas' },
  {id:'2', nome: 'Helium', quantidade: '20', fornecedor: 'hortfruit', validade: '23/04/2023', categoria: 'frutas' },
  {id: '3', nome: 'Lithium', quantidade: '20', fornecedor: 'hortfruit', validade: '23/04/2023', categoria: 'frutas' },
   ...
   private getSortedData(data: Product[]): Product[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'validade': return compare(+a.validade, +b.validade, isAsc);
